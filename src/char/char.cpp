...
enum e_char_del_response char_delete(struct char_session_data* sd, uint32 char_id){
	...
	*/
	...
	if( SQL_ERROR == Sql_Query(sql_handle, "DELETE FROM `pybot_buffer_equipset` WHERE `char_id`='%d'", char_id) ||
		...
		SQL_ERROR == Sql_Query(sql_handle, "DELETE FROM `pybot_item_not_save_mob` WHERE `char_id`='%d'", char_id) ||
		SQL_ERROR == Sql_Query(sql_handle, "DELETE FROM `pybot_item_save_mob` WHERE `char_id`='%d'", char_id) ||
		...
		SQL_ERROR == Sql_Query(sql_handle, "DELETE FROM `pybot_skill_equipset` WHERE `char_id`='%d'", char_id) ||
		SQL_ERROR == Sql_Query(sql_handle, "DELETE FROM `pybot_skill_ignore_mob` WHERE `char_id`='%d'", char_id) ||
		SQL_ERROR == Sql_Query(sql_handle, "DELETE FROM `pybot_skill_tail` WHERE `char_id`='%d'", char_id) ||
