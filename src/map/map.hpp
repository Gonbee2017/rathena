...
enum _sp {
	...
	,SP_NEAR_ASPD2
	,SP_NEAR_BASE_ATK
	,SP_NEAR_IGNORE_ASSUMPTIO
	,SP_NEAR_IGNORE_AUTOCOUNTER
	,SP_NEAR_IGNORE_AUTOGUARD
	,SP_NEAR_IGNORE_DEF_CLASS_RATE
	,SP_NEAR_IGNORE_STONESKIN
	,SP_NEAR_PERFECT_HIT_ADD_RATE
	,SP_FIX_FLEE
	,SP_FIX_FLEE2
