...
L_Attack:
	...
	sleep 10000;
	monster "airplane_01",245,57,"グレムリン",1632,1,"Airplane::OnAirEvent1";
	monster "airplane_01",247,59,"グレムリン",1632,1,"Airplane::OnAirEvent1";
	monster "airplane_01",249,52,"グレムリン",1632,1,"Airplane::OnAirEvent1";
	monster "airplane_01",243,62,"グレムリン",1632,1,"Airplane::OnAirEvent1";
	monster "airplane_01",239,52,"ビホルダー",1633,1,"Airplane::OnAirEvent1";
	monster "airplane_01",234,56,"ビホルダー",1633,1,"Airplane::OnAirEvent1";
	monster "airplane_01",227,49,"ビホルダー",1633,1,"Airplane::OnAirEvent1";
	monster "airplane_01",233,41,"ビホルダー",1633,1,"Airplane::OnAirEvent1";
	setarray .@mobid,1111,1392,1005,1049,1042;
	monster "airplane_01",251,47,"--ja--",.@mobid[rand(5)],1,"Airplane::OnAirEvent1";
	monster "airplane_01",245,53,"--ja--",.@mobid[rand(5)],1,"Airplane::OnAirEvent1";
	monster "airplane_01",234,46,"--ja--",.@mobid[rand(5)],1,"Airplane::OnAirEvent1";
	monster "airplane_01",233,58,"--ja--",.@mobid[rand(5)],1,"Airplane::OnAirEvent1";
	monster "airplane_01",243,60,"--ja--",.@mobid[rand(5)],1,"Airplane::OnAirEvent1";
	monster "airplane_01",228,54,"--ja--",.@mobid[rand(5)],1,"Airplane::OnAirEvent1";
	monster "airplane_01",232,41,"--ja--",.@mobid[rand(5)],1,"Airplane::OnAirEvent1";
	monster "airplane_01",238,56,"グレムリン",1632,1,"Airplane::OnAirEvent2";
	monster "airplane_01",239,56,"グレムリン",1632,1,"Airplane::OnAirEvent2";
	monster "airplane_01",240,50,"グレムリン",1632,1,"Airplane::OnAirEvent2";
	monster "airplane_01",241,56,"グレムリン",1632,1,"Airplane::OnAirEvent2";
	monster "airplane_01",247,51,"グレムリン",1632,1,"Airplane::OnAirEvent2";
	monster "airplane_01",237,44,"ビホルダー",1633,1,"Airplane::OnAirEvent2";
	monster "airplane_01",233,54,"ビホルダー",1633,1,"Airplane::OnAirEvent2";
	monster "airplane_01",237,62,"ビホルダー",1633,1,"Airplane::OnAirEvent2";
	sleep 5000;
	...
	sleep 500;
	misceffect 183,"Effect#AirEvent0";
	killmonster "airplane_01","Airplane::OnAirEvent2";
	sleep 5000;
	emotion 32,"飛行船船長#AirEvent";
	...
	sleep 150000;
	killmonster "airplane_01","Airplane::OnAirEvent1";
	sleep 5000;
...
//ダミーイベント
airplane_01,0,0,0	script	Airplane	-1,{
OnAirEvent1:
	end;
OnAirEvent2:
	end;
