...
prontera,164,157,2	script	シニアスタイリスト	878,{
	...
	while(1) {
		...
		case 3:
			...
			set .@cols$[getarraysize(.@cols$)], "1(黄色)^FFDEAC●^000000";
			set .@cols$[getarraysize(.@cols$)], "2(紫色)^D6B8C7●^000000";
			set .@cols$[getarraysize(.@cols$)], "3(茶色)^E5B59C●^000000";
			set .@cols$[getarraysize(.@cols$)], "4(緑色)^B8D8A5●^000000";
			set .@cols$[getarraysize(.@cols$)], "5(青色)^CECCE0●^000000";
			set .@cols$[getarraysize(.@cols$)], "6(白色)^EEDFD7●^000000";
			set .@cols$[getarraysize(.@cols$)], "7(黒色)^C39B8F●^000000";
			set .@cols$[getarraysize(.@cols$)], "8(赤色)^FABBAB●^000000";
			set .@cols$[getarraysize(.@cols$)], "9^EBC4A8●^000000";
			set .@cols$[getarraysize(.@cols$)], "10^DEE6AB●^000000";
			set .@cols$[getarraysize(.@cols$)], "11^CECCE0●^000000";
			set .@cols$[getarraysize(.@cols$)], "12^EEDFD7●^000000";
			set .@cols$[getarraysize(.@cols$)], "13^FABBAB●^000000";
			set .@cols$[getarraysize(.@cols$)], "14^FBC58B●^000000";
			set .@cols$[getarraysize(.@cols$)], "15^FFE1CF●^000000";
			set .@cols$[getarraysize(.@cols$)], "16^E3E3E3●^000000";
			set .@cols$[getarraysize(.@cols$)], "17^D0D6F2●^000000";
			set .@cols$[getarraysize(.@cols$)], "18^C2D8AF●^000000";
			set .@cols$[getarraysize(.@cols$)], "19^CFEDED●^000000";
			set .@cols$[getarraysize(.@cols$)], "20^BCD9F2●^000000";
			set .@cols$[getarraysize(.@cols$)], "21^D0F3D0●^000000";
			set .@cols$[getarraysize(.@cols$)], "22^DDB9AB●^000000";
			set .@cols$[getarraysize(.@cols$)], "23^BBF7F7●^000000";
			set .@cols$[getarraysize(.@cols$)], "24^ECCAC6●^000000";
			set .@cols$[getarraysize(.@cols$)], "25^FFC4E2●^000000";
			set .@cols$[getarraysize(.@cols$)], "26^CCE3FF●^000000";
			set .@cols$[getarraysize(.@cols$)], "27^FFE2C4●^000000";
			set .@cols$[getarraysize(.@cols$)], "28^D0ADA0●^000000";
			set .@cols$[getarraysize(.@cols$)], "29^FFF0C2●^000000";
			set .@cols$[getarraysize(.@cols$)], "30^EFECCE●^000000";
			set .@cols$[getarraysize(.@cols$)], "31^E5E2E2●^000000";
			set .@cols$[getarraysize(.@cols$)], "32^FBB09B●^000000";
			set .@cols$[getarraysize(.@cols$)], "33^FFBBD3●^000000";
			set .@cols$[getarraysize(.@cols$)], "34^EFC2DE●^000000";
			set .@cols$[getarraysize(.@cols$)], "35^FFE1B6●^000000";
			set .@cols$[getarraysize(.@cols$)], "36^E3C4EC●^000000";
			set .@cols$[getarraysize(.@cols$)], "37^F9B0AC●^000000";
			set .@cols$[getarraysize(.@cols$)], "38^FAE9BC●^000000";
			set .@cols$[getarraysize(.@cols$)], "39^F5F5F5●^000000";
			set .@cols$[getarraysize(.@cols$)], "40^A1A1A1●^000000";
