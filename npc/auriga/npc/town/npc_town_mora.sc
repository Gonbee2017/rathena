...
//	if(BIF_1QUE == 0 && BaseLevel >= 100 && YGG_1QUE == 100) {
	if(BIF_1QUE == 0 && BaseLevel >= 99 && YGG_1QUE == 100) {
		mes "[テオレ]";
		mes "うあああああ!!!!";
		mes "終わりだ！";
		mes "私はもう終わりだ!!";
...
//	if(ASH_1QUE < 100 || BaseLevel < 100) {	//異世界クエスト未クリア
	if(ASH_1QUE < 100 || BaseLevel < 99) {	//異世界クエスト未クリア
		mes "[ユリディ]";
		mes "ねえ、ちょっと。";
		mes "私のロペを……";
		mes "　";
...
//			mes "　^FF0000Baseレベル100^000000になったら";
			mes "　^FF0000Baseレベル99^000000になったら";
			mes "　再度話しかけてください‐";
			close;
		}
	}
...
//		mes "　^FF0000BaseLv110以上^000000必要です‐";
		mes "　^FF0000BaseLv99以上^000000必要です‐";
		close;
	}
...
mora,152,97,5	script	アーティファクト管理人	515,{
	...
	case 3:
		...
		mes "必要ですか？";
		next;
		switch(select("やっぱり止めます","ロードナイト","アサシンクロス","スナイパー","ハイウィザード","ハイプリースト")) {
		case 1:
			mes "[管理人]";
			mes "そうですか、必要になったら";
			mes "またいらしてください。";
...
//			}
			if(select("武器","防具") == 1) {
				switch(select("やっぱり止めます","ゴールデンロッドスタッフ[2](両手杖) -> 50枚","アクアスタッフ[2](両手杖) -> 50枚","クリムゾンスタッフ[2](両手杖) -> 50枚","フォレストスタッフ[2](両手杖) -> 50枚")) {
				case 1: break;
				case 2: set .@gain,2007; set .@coin,50; break;
				case 3: set .@gain,2008; set .@coin,50; break;
				case 4: set .@gain,2009; set .@coin,50; break;
				...
				switch(select("やっぱり止めます","ゴールデンロッドシューズ[0](靴) -> 20枚","アクアシューズ[0](靴) -> 20枚","クリムゾンシューズ[0](靴) -> 20枚","フォレストシューズ[0](靴) -> 20枚","ゴールデンロッドローブ[0](鎧) -> 20枚","アクアローブ[0](鎧) -> 20枚","クリムゾンローブ[0](鎧) -> 20枚","フォレストローブ[0](鎧) -> 20枚")) {
				case 1: break;
				case 2: set .@gain,2467; set .@coin,20; break;
				case 3: set .@gain,2468; set .@coin,20; break;
				case 4: set .@gain,2469; set .@coin,20; break;
				case 5: set .@gain,2470; set .@coin,20; break;
				case 6: set .@gain,15025;set .@coin,20; break;
				case 7: set .@gain,15026;set .@coin,20; break;
				case 8: set .@gain,15027;set .@coin,20; break;
				case 9: set .@gain,15028;set .@coin,20; break;
				}
			}
			break;
		case 6:
...
//			close;
	...
	while(1) {
		next;
		switch(select("ロードナイト","アサシンクロス","スナイパー","ハイウィザード","ハイプリースト","もういいです")) {
		case 1:
			mes "[管理人]";
			mes "どの性能を見ますか？";
			while(1) {
				...
				case 2:
					...
					mes "防御 : ^7777774^000000";
					mes "重量 : ^77777790^000000";
					mes "要求レベル : ^77777799^000000";
					mes "装備 : ^777777ロードナイト専用^000000";
		...
		case 5:
			...
			while(1) {
				...
				case 7:
					...
					mes "物理・魔法攻撃を受けた時、";
					mes "一定確率で";
					mes "[マグヌスエクソシズム]Lv 2発動";
					mes "[マグヌスエクソシズム]Lv 3以上を";
					mes "習得している場合、";
					mes "習得レベルで発動";
					mes "―――――――――――――";
					mes "系列 : ^777777肩にかける物^000000";
