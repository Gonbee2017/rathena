...
new_1-1,148,112,0		warp	newwarp6001_1		2,2,new_1-2,100,9
new_2-1,148,112,0		warp	newwarp6001_2		2,2,new_1-2,100,9
new_3-1,148,112,0		warp	newwarp6001_3		2,2,new_1-2,100,9
new_4-1,148,112,0		warp	newwarp6001_4		2,2,new_1-2,100,9
new_5-1,148,112,0		warp	newwarp6001_5		2,2,new_1-2,100,9
...
geffen_in,106,181,0		warp	geffenwarp1006		2,2,geffen,179,62
...
moc_ruins,159,37,0		warp	moroccwarp1079		3,3,morocc,29,290
...
yuno_in05,153,141,0		script	#yunowarp1065	45,1,1,{
	switch(rand(2)) {
...
yuno_in05,196,102,0		script	#yunowarp1066	45,1,1,{
	switch(rand(3)) {
...
yuno_in05,181,116,0		script	#yunowarp1067	45,1,1,{
	switch(rand(3)) {
...
yuno_in05,165,102,0		script	#yunowarp1068	45,1,1,{
	switch(rand(2)) {
		case 0:	warp "yuno_in05",192,102; end;
		case 1:	warp "yuno_in05",145,82;  end;
	}
}
yuno_in05,181,91,0		script	#yunowarp1069	45,1,1,{
	switch(rand(2)) {
...
yuno_in05,148,82,0		script	#yunowarp1070	45,1,1,{
	switch(rand(3)) {
		case 0:	warp "yuno_in05",169,102; end;
		case 1:	warp "yuno_in05",128,82;  end;
		case 2:	warp "yuno_in05",156,141; end;
...
yuno_in05,125,82,0		script	#yunowarp1071	45,1,1,{
	switch(rand(2)) {
		case 0:	warp "yuno_in05",192,102; end;
		case 1:	warp "yuno_in05",145,82;  end;
	}
}
yuno_in05,136,71,0		script	#yunowarp1072	45,1,1,{
	switch(rand(3)) {
		case 0:	warp "yuno_in05",181,112; end;
...
yuno_in05,16,188,0		script	#yunowarp1073	45,1,1,{
	switch(rand(3)) {
		case 0:	warp "yuno_in05",181,94; end;
		case 1:	warp "yuno_in05",176,13; end;
		case 2:	warp "yuno_in05",136,75; end;
...
yuno_in05,176,9,0		script	#yunowarp1074	45,1,1,{
	switch(rand(2)) {
		case 0:	warp "yuno_in05",181,112; end;
		case 1:	warp "yuno_in05",176,48;  end;
	}
}
yuno_in05,176,52,0		script	#yunowarp1075	45,1,1,{
	switch(rand(3)) {
		case 0:	warp "yuno_in05",181,94; end;
		case 1:	warp "yuno_in05",176,13; end;
		case 2:	warp "yuno_in05",136,75; end;
...
valkyrie,49,72,0	warp	valkyriewarp6001	1,1,valkyrie,49,63
