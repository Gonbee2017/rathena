...
L_NOVICE:
	...
	mes "行ってみてね。";
	close2;
	warp name$[.@num],.map_xy[.@num*2],.map_xy[.@num*2+1];
	end;
L_EXPERT:
	mes "[ヘイム]";
	mes "きみくらい貫禄のある冒険者だと、";
...
L_CANCEL:
	...
	close;
OnInit:
	setarray name$,"prontera","izlude","morocc","alberta","geffen","payon","aldebaran","yuno","umbala","comodo","hugel","rachel","lighthalzen","veins","gonryun","louyang","ayothaya","amatsu","einbroch",  "einbech";
