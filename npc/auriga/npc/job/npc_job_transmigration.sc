...
//	callfunc "JobChanger","ロードナイト",Job_Swordman,Job_Knight;
	callfunc "JobChanger","ロードナイト",Job_Swordman_High,Job_Knight;
	mes "[ロードナイト]";
	mes "栄光のヴァルハラへよく来たな。";
	mes "しばし休息をとりたまえ。";
	mes "戦士に光あれ！";
...
//	callfunc "JobChanger","ハイプリースト",Job_Acolyte,Job_Priest;
	callfunc "JobChanger","ハイプリースト",Job_Acolyte_High,Job_Priest;
	mes "[ハイプリースト]";
	mes "栄光のヴァルハラへよくぞ";
	mes "お越しくださいました。";
	mes "是非、休息をおとりください。";
...
//	callfunc "JobChanger","ハイウィザード",Job_Magician,Job_Wizard;
	callfunc "JobChanger","ハイウィザード",Job_Magician_High,Job_Wizard;
	mes "[ハイウィザード]";
	mes "栄光のヴァルハラへようこそ。";
	mes "しばし休息をおとりください。";
	mes "戦士に光あれ！";
...
//	callfunc "JobChanger","ホワイトスミス",Job_Merchant,Job_Blacksmith;
	callfunc "JobChanger","ホワイトスミス",Job_Merchant_High,Job_Blacksmith;
	mes "[ホワイトスミス]";
	mes "栄光のヴァルハラによく来たな。";
	mes "まあ、少し休んでいけよ。";
	mes "戦士に光あれ！";
...
//	callfunc "JobChanger","スナイパー",Job_Archer,Job_Hunter;
	callfunc "JobChanger","スナイパー",Job_Archer_High,Job_Hunter;
	mes "[スナイパー]";
	mes "栄光のヴァルハラへようこそ。";
	mes "是非おくつろぎください。";
	mes "戦士に光あれ！";
...
//	callfunc "JobChanger","アサシンクロス",Job_Thief,Job_Assassin;
	callfunc "JobChanger","アサシンクロス",Job_Thief_High,Job_Assassin;
	mes "[アサシンクロス]";
	mes "ヴァルハラへよく来たな。";
	mes "少し休んでいけ。";
	mes "幸運を祈る！";
...
//	callfunc "JobChanger","パラディン",Job_Swordman,Job_Crusader;
	callfunc "JobChanger","パラディン",Job_Swordman_High,Job_Crusader;
	mes "[パラディン]";
	mes "栄光のヴァルハラへよくぞ来た。";
	mes "少し休んでいきなさい。";
	mes "戦士に光あれ！";
...
//	callfunc "JobChanger","チャンピオン",Job_Acolyte,Job_Monk;
	callfunc "JobChanger","チャンピオン",Job_Acolyte_High,Job_Monk;
	mes "[チャンピオン]";
	mes "栄光のヴァルハラへよく来た。";
	mes "少し休んでいきな。";
	mes "戦士に光あれ！";
...
//	callfunc "JobChanger","プロフェッサー",Job_Magician,Job_Sage;
	callfunc "JobChanger","プロフェッサー",Job_Magician_High,Job_Sage;
	mes "[プロフェッサー]";
...
//	callfunc "JobChanger","チェイサー",Job_Thief,Job_Rogue;
	callfunc "JobChanger","チェイサー",Job_Thief_High,Job_Rogue;
	mes "[チェイサー]";
	mes "ヴァルハラへよく来たな～！";
	mes "ちょいと休みなよ。";
	mes "幸運を祈る！";
...
//	callfunc "JobChanger","クリエイター",Job_Merchant,Job_Alchemist;
	callfunc "JobChanger","クリエイター",Job_Merchant_High,Job_Alchemist;
	mes "[クリエイター]";
	mes "栄光のヴァルハラへようこそ！";
	mes "少しここで休んでいきな。";
	mes "戦士に光あれ！";
...
//	callfunc "JobChanger","クラウン",Job_Archer,Job_Bard;
	callfunc "JobChanger","クラウン",Job_Archer_High,Job_Bard;
	mes "[クラウン]";
	mes "栄光のヴァルハラへようこそ。";
...
//	callfunc "JobChanger","ジプシー",Job_Archer,Job_Dancer;
	callfunc "JobChanger","ジプシー",Job_Archer_High,Job_Dancer;
	mes "[ジプシー]";
	mes "栄光のヴァルハラへようこそ！";
	mes "少し休んでから帰りなさいな。";
	mes "戦士に光あれ！";
